...
public class ColorLegend extends JPanel {
    ...
    private int pad_x = 0;
    private int pad_y = 10;
    private int box_width = 15;
    ...
    protected void paintComponent(Graphics g) {
        ...
        g2.drawString("1", pad_x + 4, pad_y - 3);  
        g2.drawString("16", pad_x + 4 * box_width, pad_y - 3);
        g2.drawString("256", pad_x + 8 * box_width - 2, pad_y - 3);
        g2.drawString(">4000", pad_x + 11 * box_width - 10, pad_y - 3);
    }

    @Override
    public int getWidth() {
        return pad_x + box_width * colors.length + 12;
    }

    @Override
    public int getHeight() {
        return box_height + pad_y + 1;
    }
}
