...
public class Input implements Comparable<Input>, Cloneable {
    ...
    public static class ComparatorAvgCostInput implements Comparator<Input> {
        ...
        @Override
        public int compare(Input t1, Input t2) {
            if (t1.getAvgCost() == t2.getAvgCost()) {
                return 0;
            }
            if (t1.getAvgCost() > t2.getAvgCost()) {
                return 1;
    ...
    public double getVar() {
        ...
        double variance = ((getSqrCost() / getCalls())
    ...
    public double getRatio() {
        return getRatioCost(CostKind.WORST);
    }
        ...
        switch (type) {
            ...
            case 1:
                if (size <= 1) {
                    ...
                    return (cost / (size * Math.log(size)));
                }
            case 2:
                if (size == 0) {
                    return cost;
                } else {
                    return (cost / Math.pow(size, 2));
                }
        }
        return 0;
    }
