...
/*
 * MergeReportsDialog.java
 *
 * Created on 26-mag-2010, 23.16.15
 */
...
public class MergeReportsDialog extends javax.swing.JDialog {
    ...
    public MergeReportsDialog(java.awt.Frame parent, boolean modal) {
        ...
        javax.swing.filechooser.FileNameExtensionFilter filter = new javax.swing.filechooser.FileNameExtensionFilter("Aprof report files (*.log)", "log");
    ...
    private void jButton6ActionPerformed(ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        if (files != null && files.length > 0) ((MergeListModel)jList1.getModel()).add(files);
    }//GEN-LAST:event_jButton6ActionPerformed

    private void jButton7ActionPerformed(ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        // TODO add your handling code here:
        int index = jList1.getSelectedIndex();
        if (index >= 0) ((MergeListModel)jList1.getModel()).remove(index);
    ...
    private void jButton3ActionPerformed(ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        java.io.File res;
        try {
            res = AprofReport.merge(((MergeListModel)jList1.getModel()).getElements(), new java.io.File(jTextField1.getText()));
            System.gc();
            this.dispose();
            ...
            if (e instanceof java.io.IOException)
                javax.swing.JOptionPane.showMessageDialog(this, "Couldn't open the selected files");
            else
                javax.swing.JOptionPane.showMessageDialog(this, "Error while merging files:\n" + e.getMessage());
            //this.dispose();
        }
    ...
    private void jFileChooser1ActionPerformed(ActionEvent evt) {//GEN-FIRST:event_jFileChooser1ActionPerformed
        // TODO add your handling code here:
        //javax.swing.JOptionPane.showMessageDialog(this, "Action performed");
        java.io.File[] files = jFileChooser1.getSelectedFiles();
        if (files != null && files.length > 0) ((MergeListModel)jList1.getModel()).add(files);
